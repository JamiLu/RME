...
var RMEElemRenderer = /*#__PURE__*/function () {
  ...
  _createClass(RMEElemRenderer, [{
    ...
    value: function merge(newStage) {
      ...
      var newChildren = newStage.children;
      var i = 0;
    ...
    value: function render(parent, oldNode, newNode, index) {
      if (!oldNode && newNode) {
        ...
        var newLength = newNode ? newNode.children.length : 0;
        while (i < newLength || i < oldLength) {
          this.render(parent.children[index], oldNode ? oldNode.children[i] : null, newNode ? newNode.children[i] : null, i);
          i++;
        }
      }
    }
    ...
    value: function clearPending() {
      if (this.pendingRemove.length > 0) {
        var lastIdx = this.pendingRemove.length - 1;
        while (lastIdx >= 0) {
  ...
  _createClass(RMEAppComponent, [{
    ...
    value: function render(props, parent, componentLiteral) {
      ...
      if (this.afterRenderTasks.length > 0) {
        Browser.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _this4.afterRenderTasks.forEach( /*#__PURE__*/function () {
                  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(hook) {
...
var Elem = /*#__PURE__*/function () {
  ...
  _createClass(Elem, [{
    ...
    value: function getProps(json) {
      if (json === true) return JSON.stringify(RMEElemTemplater.getElementProps(this));else return RMEElemTemplater.getElementProps(this);
    }
    ...
    value: function render() {
      ...
      if (!Elem.RenderHelper.isNewStateEqualToPrevState(newState)) {
        Elem.RenderHelper.setPrevState(null);
      ...
      Elem.RenderHelper.setPrevState(newState);
      return this;
    }
 ...
 */
Elem.RenderHelper = /*#__PURE__*/function () {
 ...
 */
var RMETemplateElement = /*#__PURE__*/function (_Elem) {
  _inherits(RMETemplateElement, _Elem);
  var _super = _createSuper(RMETemplateElement);
  function RMETemplateElement(type) {
    var _this12;
    _classCallCheck(this, RMETemplateElement);
    _this12 = _super.call(this, type);
    _this12.props = {};
    _this12.stringProps;
    _this12.listeners = [];
    _this12.attributes = [];
    _this12.attributeString = '';
    _this12.listenerObj = {};
    _this12.listenerString = '';
    _this12.children = [];
    _this12.inlineProps = {};
    return _this12;
  }
  _createClass(RMETemplateElement, [{
    key: "hasListeners",
    ...
    key: "updateListeners",
    value: function updateListeners(elem) {
      var _this13 = this;
      if (elem.hasListeners()) {
        elem.listeners.forEach(function (listener) {
          _this13[listener.parentProp.name].call(_this13, listener.func);
        });
    ...
    value: function updateAttributes(elem) {
    ...
    key: "setId",
    value: function setId(id) {
      _get(_getPrototypeOf(RMETemplateElement.prototype), "setId", this).call(this, id);
    ...
    key: "addClasses",
    value: function addClasses(classes) {
      _get(_getPrototypeOf(RMETemplateElement.prototype), "addClasses", this).call(this, classes);
      this.inlineProps["class"] = _get(_getPrototypeOf(RMETemplateElement.prototype), "getClasses", this).call(this);
      RMETemplateElement.Util.formProps(this);
      return this;
    }
    ...
    key: "addInlineAttr",
    value: function addInlineAttr(key, val) {
    ...
    value: function append(element) {
      ...
      _get(_getPrototypeOf(RMETemplateElement.prototype), "append", this).call(this, element);
      return this;
    }
    ...
    key: "remove",
    value: function remove(index, element) {
      this.children.splice(index, 1);
      _get(_getPrototypeOf(RMETemplateElement.prototype), "remove", this).call(this, element);
      return this;
    }
    ...
    key: "replace",
    value: function replace(index, parent, element) {
      parent.children.splice(index, 1, element);
      this.inlineProps = element.inlineProps;
      RMETemplateElement.Util.formProps(element);
      _get(_getPrototypeOf(RMETemplateElement.prototype), "replace", this).call(this, element);
      return this;
    }
    ...
    key: "getPropsString",
    value: function getPropsString() {
      return this.stringProps;
    }
  }, {
    key: "getPropsObj",
    value: function getPropsObj() {
      return this.props;
    }
 ...
 */
RMETemplateElement.Util = /*#__PURE__*/function () {
  function RMETemplateElementUtil() {
    _classCallCheck(this, RMETemplateElementUtil);
  }
  _createClass(RMETemplateElementUtil, null, [{
    key: "duplicateElem",
    value: function duplicateElem(elem) {
      var dup = new RMETemplateElement(elem.getTagName().toLowerCase());
      ...
      if (elem.children.length > 0) {
        elem.children.map(function (child) {
          return RMETemplateElement.Util.duplicateElem(child);
        }).forEach(function (child) {
          return dup.append(child);
        });
      }
      return dup;
    }
    ...
    key: "setListeners",
    value: function setListeners(elem, listeners) {
      if (listeners.length > 0) {
        elem.listeners = listeners;
        elem.listenerObj = listeners.reduce(function (prev, curr) {
          prev[curr.parentProp.name] = curr.func;
          return prev;
        }, {});
        elem.listenerString = listeners.map(function (listener) {
          return listener.parentProp.name;
        }).join();
      }
    }
    ...
    key: "setAttributes",
    value: function setAttributes(elem, attrs, override) {
      if (attrs.length > 0 || override) {
        elem.attributes = attrs.filter(function (attr) {
          if (attr.key !== 'class') {
            return attr;
          }
        });
    ...
    key: "formProps",
    value: function formProps(elem) {
      var props = elem.attributes.reduce(function (prev, curr) {
        prev[curr.key] = curr.val;
        return prev;
      }, _objectSpread(_objectSpread({}, elem.inlineProps), elem.listenerObj));
      elem.props = props;
    ...
    key: "updateBrowserSetStyle",
    value: function updateBrowserSetStyle(elem, props) {
  ...
  var Template = /*#__PURE__*/function () {
    ...
    _createClass(Template, [{
      ...
      value: function isAttr(key, elem) {
         ...
         * special cases below.
         */
        if (key === "span" && Template.isElem(elem.getTagName(), ["col", "colgroup"]))
          //special case, span might be an attribute also for these two elements.
