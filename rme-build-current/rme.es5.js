...
var RMEElemRenderer = /*#__PURE__*/function () {
  ...
  _createClass(RMEElemRenderer, [{
    ...
    value: function render(parent, oldNode, newNode, index) {
      if (!oldNode && newNode) {
        ...
        if (!!oldNode && !!newNode && !oldNode.equals(newNode)) {
          oldNode.setProps(_objectSpread(_objectSpread({}, this.getBrowserSetStyle(oldNode)), newNode.getPropsObj()));
    ...
    value: function getBrowserSetStyle(oldNode) {
...
RMETemplateElement.Util = /*#__PURE__*/function () {
  ...
  _createClass(RMETemplateElementUtil, null, [{
    ...
    key: "setAttributes",
    value: function setAttributes(elem, attrs) {
      if (attrs.length > 0) {
