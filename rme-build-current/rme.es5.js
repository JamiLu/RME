            ...
            if (!Util.isEmpty(_this2.router)) {
              ...
              if (!Util.isEmpty(state.current)) {
                ...
                if (Template.isFragment(element)) {
                  var fragment = {};
                  fragment[state.rootElem.getTagName().toLowerCase() + selector] = _objectSpread({}, element.fragment);
      ...
      value: function updateElemProps(elem, props) {
        ...
        for (var p in props) {
          if (props.hasOwnProperty(p)) {
            ...
            else if (p === 'class') elem.updateClasses(props[p]);else templater.resolveAttributes(elem, p, props[p]);
          }
        }
      }
    }, {
